...
public class MyMatrix
{
    ...
    protected static float[,] Multiply(MyMatrix matrix, float scalar)
    {
    ...
    protected static float[,] Multiply(MyMatrix matrix1, MyMatrix matrix2)
    {
    ...
    public static MyMatrix operator *(MyMatrix m, float scalar)
    {
        return new MyMatrix(Multiply(m, scalar));
    }

    public static MyMatrix operator *(MyMatrix m1, MyMatrix m2)
    {
        return new MyMatrix(Multiply(m1, m2));
    }
